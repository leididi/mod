#!/usr/bin/env python 
# -*- coding:utf-8 -*-
from Contrast_Json import compare_dict
from Gen_Csv import gen_csv
import sys
...
if __name__ == "__main__":
    ...
    check(src,dst,num_model='small',num_limit=4)
    # src={"k1" :{"k11":[{"listk111": "北京"},{"listk112": "上海"}],"k12":{"listk121": 7}},"k2":{"listk21": "广州"} }
    # dst={"k1":{"k12":{"listk121": 7},"k11":[{"listk111": "北京"},{"listk112": "上海"}]}}
    # check(src, dst)